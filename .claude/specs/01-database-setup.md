...
This step establishes the **data layer foundation** for the moneygoes application.
...
- Opens connection to `moneygoes.db` (or `expense_tracker.db`) in project root
- Sets:
...
- Inserts one demo user:
    - name: Demo User
    - email: [demo@moneygoes.com](mailto:demo@moneygoes.com)
